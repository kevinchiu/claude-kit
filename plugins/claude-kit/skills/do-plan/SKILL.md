...
- subagent_type: Explore
- model: sonnet
- prompt: Find patterns for [PLAN AREA]. Use Grep to search, LSP find-references for usage - you have 1M context. Report: pattern locations, full code examples, conventions.
